...
### Contrast — ที่ต่างจากดีไซน์เพราะดีไซน์ไม่ผ่าน

วัดทุกคู่สีที่ใช้จริง เจอ fail 6 จุด แก้แล้วทั้งหมด (เกณฑ์ WCAG AA — ตัวอักษรปกติ 4.5:1 · icon/กราฟิก 3:1)

| จุด | เดิม | ใหม่ | |
|---|---|---|---|
| แถบรางวัล · ตัวอักษรสีชมพูอ่อน | `#FFE2E2` บน `#E32321` = **3.80** | บน `primary-dark` `#991B1B` = **6.82** | เข้มแถบลงแทนที่จะทิ้งโทนชมพู |
| hero MSN-210 | เหมือนกัน | เหมือนกัน | header ยังเป็น `#E32321` — chrome กับ content เป็นแดง 2 ระดับ |
...
รูปทุกใบ `object-fit: cover` เต็มกล่อง · hero เป็น 358×150 แต่ต้นฉบับเป็นจัตุรัส **จึงตัดบน-ล่าง** —
ถ้าอยากเห็นสินค้าเต็มตัวต้องขอ crop แนวนอนมาเพิ่ม
