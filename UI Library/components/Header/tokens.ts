...
export const HEADER = {
  ...
  mainGap: t.ref('header-main-gap'),
  mainTitleSize: t.ref('header-main-title-size'),
  mainTitleLineHeight: t.ref('header-main-title-line-height'),
  mainTitleWeight: t.ref('header-main-title-weight'),
